...
export const skillDomains: readonly SkillDomain[] = [
	...
	},
	{
		...
		skills: ["RAG", "AI agents", "LLM applications", "MCP", "APIs", "Evaluation harnesses"],
		evidence: "Lesson assistant, WhatsApp agent",
		accent: "azure",
	},
	{
		...
		skills: ["Exploratory analysis", "Statistical modelling", "SQL", "Feature design", "Visualisation"],
	...
	},
	{
		...
		skills: ["Python", "TypeScript", "Node.js", "Docker", "Git", "PostgreSQL", "Linux"],
